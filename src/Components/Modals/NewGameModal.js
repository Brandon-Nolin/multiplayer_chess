  ...
  return (
    <div className="absolute flex justify-center items-center w-full h-screen bg-zinc-950/90 z-10">
      <div className="w-1/3 shadow-lg top-0 opacity-100">
        <div className="bg-zinc-600 flex justify-center items-center rounded-t-lg">
        ...
        <div className="bg-zinc-800 rounded-b-lg">
          <div className="flex justify-between py-10 px-6">
            <button
              type="button"
              class="rounded-md bg-blue-700 px-8 py-2.5 text-2xl font-semibold text-gray-200 shadow-sm hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Find Game
            </button>
            <button
              onClick={createGame}
              type="button"
              class="rounded-md bg-zinc-800 px-8 py-2.5 text-2xl font-semibold text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-zinc-700"
            >
              Play a Friend
            </button>
          </div>
          <div className={`p-6 ${roomCode ? "block" : "hidden"}`}>
